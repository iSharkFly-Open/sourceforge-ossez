...
$('a#options-add-extra').click(function() { 
	...
	var tr_id = parseInt($("tr.dragable:last").attr('id')) + 1;
	$("tr.dragable:last")
	.after("<tr class=\"dragable\" id=\""+tr_id+"\"><td align=\"center\" ><b>"+tr_id+"</b></td><td><input class=\"inputbox checkit\" type=\"text\" name=\"apolloptionextra[]\" id=\"apolloptionextra"+ tr_id +"\" value=\"\" size=\"60\" /><input type=\"hidden\" name=\"extra_ordering[]\" id=\"extra_ordering"+tr_id+"\" value=\""+(tr_id-1)+"\" class=\"ordering\" /></td><td><div style=\"position:relative;\"><input type=\"hidden\" size=\"7\"  name=\"extra_colors[]\" id=\"extra_colors"+(tr_id-1)+"\" value=\"#ff00ff\" class=\"colorpicker\" />&nbsp;</div></td><td></td></tr>");
	$("tr.dragable:last").hide();
	$(".colorpicker:last").colorPicker();
	$("#reorder").tableDnDUpdate();
 	$("tr.dragable:last").css({'backgroundColor':'#99cc00'})
	...
	$("input[name^='apolloptionextra']").focus();	
