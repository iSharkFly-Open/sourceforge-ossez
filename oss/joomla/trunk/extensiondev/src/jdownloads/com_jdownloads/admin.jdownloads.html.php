	  ...
	  <tr>
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="center">
				<?php
                if ($row->published) {
                    $url_cat_link = JRoute::_('<a href="'.$mainframe->getSiteURL().'index.php?option=com_jdownloads&amp;Itemid=999999&amp;task=viewcategory&amp;catid='.$row->id.'" target="_blank">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').'</a>');
                    echo $url_cat_link;
                } else {
                    echo '';
                }        
		...
		<tr>
		  <td align="center" colspan="13"><?php echo $pageNav->getPagesLinks(); ?></td>
	  	</tr>
		<tr>
		  <td align="center" colspan="13"><?php echo $pageNav->getPagesCounter(); ?></td>
	  	</tr>
	</table> 
	<input type="hidden" name="boxchecked" value="0">
	<input type="hidden" name="option" value="<?php echo $option; ?>">
		    	...
		    	<tr>
		      	...
		      	<tr>
		      		<td valign="top" align="left" width="100%">
                       ...
                       if($row->url_download != ''){ ?>
                            <tr>
                                ...
                                <td valign ="top"><?php echo JText::_('JLIST_BACKEND_FILE_EDIT_EXT_DOWNLOAD_INFO');?>
                                  </td>
                              </tr>
                            <tr>
                                <td>
                                    <a href="index2.php?option=<?php echo $option;?>&task=files.remove&cid=<?php echo $row->file_id;?>"><?php echo JText::_('JLIST_BACKEND_FILESEDIT_FILE_REMOVE');?><br /><br /></a>
                                </td>
                              </tr>
                     ...
                     <?php } else { ?>
                            ...
                            <tr>
                                <td><strong><?php echo JText::_('JLIST_BACKEND_FILESEDIT_FILE_ADD_FROM_SERVER_NO')." "; ?></strong><br />
                                <?php echo ''; ?>
                                <br />
                                  </td>
                              </tr>
...
/  Configuration
/ =============================================== */
function showConfig($option, $list_sortorder, $cats_sortorder, $user_groups, $file_plugin_inputbox, $file_plugin_inputbox2, $inputbox_pic, $inputbox_pic_file, $inputbox_hot, $inputbox_new, $inputbox_down, $inputbox_down2, $inputbox_mirror_1, $inputbox_mirror_2, $inputbox_upd){
	global $jlistConfig, $mainframe;
	jimport( 'joomla.html.pane');
  ?>
  <form action="index2.php" method="post" name="adminForm" id="adminForm">
		      	...
		      	<tr>
		      		<td valign="top" align="left" width="100%">
                        ...
                        <tr>
                          <td valign="top">
                               <script language="javascript" type="text/javascript">
                                if (document.forms[0].down_pic2.options.value!=''){
