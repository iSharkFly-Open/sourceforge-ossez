...
<form method="post" action="index.php" name="adminForm" id="adminForm">
  <table align="left">
    <tr>
      ...
      <td ><p id="gen"><img src="<?php echo JURI::root() ?>administrator/index.php?option=com_ninjarsssyndicator&task=genbtn&outerBorder=#666666&innerBorder=#ffffff&barPosition=25&leftFill=#ff6600&leftText=RSS&leftTextColor=#ffffff&leftTextPosition=5&rightFill=#898E79&rightText=Valid&rightTextColor=#ffffff&rightTextPosition=29" alt="" id="generated" height="15" width="80"></p></td>
    </tr>
    <tr>
...
function renderImage(action) {
	...
	qs = qs.replace(re, '') ;
	imgUrl = url+"administrator/index.php?option=com_ninjarsssyndicator&task=genbtn&"+qs
	$("generated").src= imgUrl;
	return imgUrl;
}
