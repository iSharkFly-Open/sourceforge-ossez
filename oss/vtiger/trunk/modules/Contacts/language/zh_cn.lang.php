...
// Added for 4GA
 ...
 'Department' => '部门',
  ...
  'Mailing State' => '市（县）',
  'Mailing Zip' => '邮政编码',
  'Mailing Country' => '省（市/自治区）',
  'Mailing Po Box' => '采购订单信箱',
  'Other Po Box' => '其它采购订单信箱',
  'Other City' => '乡镇市区',
  'Other State' => '市（县）',
  'Other Zip' => '邮政编码',
  'Other Country' => '省（市/自治区）',
  'Contact Image' => '照片',
  'Description' => '描述',
...
'Name' => '名称',
  'LBL_ALL' => '全部',
  'LBL_MAXIMUM_LIMIT_ERROR' => '抱歉，文件超过系统限制，请保持上传文件在 800000 bytes 以下',
...
//Added for 5.0.3
'Customer Portal Login Details'=>'顾客注册细节',
'Dear'=>'亲爱的',
'Your Customer Portal Login details are given below:'=>'您的顾客提供了以下注册细节:',
'User Id :'=>'用户号 :',
'Password :'=>'密码 :',
'Please Login Here'=>'请在这里登录',
'Note :'=>'笔记 :',
'We suggest you to change your password after logging in first time'=>'请您在第一次登录时修改密码以保证安全.',
'Support Team'=>'项目团队',
