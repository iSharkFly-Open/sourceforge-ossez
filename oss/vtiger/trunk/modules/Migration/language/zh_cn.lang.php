...
'LBL_SOURCE_VT_MYSQL_DUMPFILE' => 'vtiger <b>来源版本</b> 汇出资料的文件名称',
'LBL_NOTE_TITLE' => '备注：',
'LBL_NOTES_LIST1' => '如果目前的数据库是在同一台机器，输入数据库路径（或）输入汇出数据的文件名称。',
'LBL_NOTES_LIST2' => '如果目前的数据库存在于不同机器，输入（来源）汇出数据的文件名称与完整路径。',
'LBL_NOTES_DUMP_PROCESS' => '要将数据库汇出，请参考下面指令：<br><b>mysqldump --user="mysql_username"  --password="mysql-password" -h "hostname"  --port="mysql_port" "database_name" > dump_filename</b><br>新增 <b>SET_FOREIGN_KEY_CHECKS = 0;</b> -- 到档案开始的地方<br>新增 <b>SET_FOREIGN_KEY_CHECKS = 1;</b> -- 到档案结束的地方',
'LBL_NOTES_LIST3' => '提供数据库的路径，像是 <b>/home/crm/vtigerCRM4_5/mysql</b>',
'LBL_NOTES_LIST4' => '提供汇出数据的档案路径，像是 <b>/home/fullpath/4_2_dump.txt</b>',
...
'LBL_RADIO_BUTTON1_DESC' => '这个选项需要主机（数据库所在）地址与数据库权限细节，这个方法同时支持本地与远程系统，细节请参考文件说明。',
'LBL_RADIO_BUTTON2_TEXT' => '我有 vtiger CRM 数据库备份',
'LBL_RADIO_BUTTON2_DESC' => '这个选项需要有数据库备份文件在同一台机器来进行升级，您无法存取不同主机（远程数据库服务器）的备份数据，细节请参考文件说明。',
'LBL_RADIO_BUTTON3_TEXT' => '我有新的数据库包含 4.2.3 数据',
'LBL_RADIO_BUTTON3_DESC' => '这个选项需要 vtiger CRM 4.2.3 数据库系统细节，包含服务器编号、账号与密码，您无法存取不同主机（远程数据库服务器）的备份数据。',
