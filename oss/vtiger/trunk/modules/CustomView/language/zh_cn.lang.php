 ...
 ********************************************************************************/ 
$mod_strings = Array( 
 'LBL_MODULE_NAME' => '自订检视表',
  'LBL_STEP_1_TITLE' => '检视表信息',
  'LBL_VIEW_NAME' => '检视表名称：',
  'LBL_SETDEFAULT' => '默认值',
  'LBL_LIST_IN_METRICS' => '制式化列表',
  'LBL_STEP_2_TITLE' => '选择字段',
  'LBL_STEP_3_TITLE' => '标准规则',
  'LBL_STEP_4_TITLE' => '进阶规则',
  'LBL_STEP_5_TITLE' => '存取信息',
  'LBL_SF_COLUMNS' => '字段',
  'LBL_SF_STARTDATE' => '开始日期',
  'LBL_SF_ENDDATE' => '结束日期',
  'LBL_AF_HDR1' => '设定搜寻条件来缩小范围',
  'LBL_AF_HDR2' => '您可以在第三个字段输入多个项目，之前用"or"分开 ',
...
'Account Name' => '公司名称',
  ...
  'Shipping Po Box' => '[送货住址]邮政信箱',
  'Billing Po Box' => '[付款住址]邮政信箱',
...
//Strings added for Contacts module fields 
 ...
 'Office Phone' => '办公室电话',
  ...
  'Do Not Call' => '拒绝电话打扰',
  'Mailing Street' => '街道巷弄',
  'Other Street' => '[其它]街道巷弄',
  'Mailing Po Box' => '邮政信箱',
  'Other Po Box' => '[其它]邮政信箱',
  'Mailing City' => '乡镇市区',
  'Other City' => '[其它]乡镇市区',
  'Mailing State' => '县市',
  'Other State' => '[其它]县市',
...
'Product Code' => '产品代号',
  ...
  'Support Start Date' => '开始支持日期',
  'Support Expiry Date' => '结束支持日期',
  'Vendor Name' => '厂商名称',
  'Mfr PartNo' => '工厂零件代号',
  'Vendor PartNo' => '厂商零件代号',
...
'Campaign Name' => '活动名称',
  ...
  'TargetSize' => '目标数量',
  'Sponsor' => '赞助商',
  'Expected Sales Count' => '预期销售量',
  'Expected Response Count' => '预期回应量',
  'Expected ROI' => '预期收益',
  'Actual Sales Count' => '实际销售量',
  'Actual Response Count' => '实际回应量',
  'Actual ROI' => '实际收益',
...
//Added for customview.tpl 
 ...
 'LBL_Select_a_Column' => '选择字段',
  ...
  'Details' => '细节',
  'New_Custom_View' => '新增自订检视',
  'LBL_AF_HDR5' => '简易时间过滤可以让您选择介于客户建立时间与异动时间之间的日期',
  'Select_Duration' => '选择期间',
...
'LBL_SET_AS_PUBLIC'=>'设为公共 ',
'LBL_NEW'=>'新',
'LBL_EDIT'=>'修改',
'LBL_STATUS_PUBLIC_APPROVE'=>'批准',
