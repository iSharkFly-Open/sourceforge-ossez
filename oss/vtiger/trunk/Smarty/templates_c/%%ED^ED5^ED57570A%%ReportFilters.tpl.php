<?php /* Smarty version 2.6.18, created on 2010-04-11 10:45:07
...
<table class="small" bgcolor="#ffffff" border="0" cellpadding="5" cellspacing="0" height="530" width="100%">
	...
	<tr><td colspan="2">
		...
		<tr>
		<td class="dvtCellLabel"><?php echo $this->_tpl_vars['MOD']['LBL_SF_COLUMNS']; ?>
:</td>
		<td class="dvtCellLabel">&nbsp;</td>
		<td class="dvtCellLabel"><?php echo $this->_tpl_vars['MOD']['LBL_SF_STARTDATE']; ?>
:</td>
		<td class="dvtCellLabel"><?php echo $this->_tpl_vars['MOD']['LBL_SF_ENDDATE']; ?>
:</td>
		</tr>
		<tr>
...
", showsTime : false, button : "jscal_trigger_date_end", singleClick : true, step : 1
		...
		<td>&nbsp;</td>
			...
			<tr><td colspan="2" class="detailedViewHeader"><b><?php echo $this->_tpl_vars['MOD']['LBL_ADVANCED_FILTER']; ?>
</b>
			</td>
			...
			<td colspan="4">
			<ul>
			<li><?php echo $this->_tpl_vars['MOD']['LBL_AF_HDR2']; ?>
</li> 
			<li><?php echo $this->_tpl_vars['MOD']['LBL_AF_HDR3']; ?>
</li>
			</ul>  
			</td>	
			</tr>
			...
			<?php echo $this->_tpl_vars['FOPTION1']; ?>

			</select>
			</td>
			<td class="dvtCellLabel"><input name="fval1" id="fval1" class="repBox" type="text" value="<?php echo $this->_tpl_vars['VALUE1']; ?>
">
			<img height=20 width=20 style="cursor: pointer;" title="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" src='themes/images/terms.gif' onClick="placeAtCenterOfDiv(adv_filter_div,show_val1);showHideSelectDiv('show_val1');"/>
			<input type="image" align="absmiddle" style="cursor: pointer;" onclick="$('fval1').value='';return false;" language="javascript" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" src="themes/images/clear_field.gif"/>
			</td>
			<td class="dvtCellLabel"><?php echo $this->_tpl_vars['MOD']['LBL_AND']; ?>
</td>
			</tr>
			<tr>
			<td class="dvtCellInfo">
	        ...
	        <?php echo $this->_tpl_vars['FOPTION2']; ?>

			</select>
			</td>
			<td class="dvtCellInfo"><input name="fval2" id="fval2" class="repBox" type="text" value="<?php echo $this->_tpl_vars['VALUE2']; ?>
">
			<img height=20 width=20 style="cursor: pointer;" title="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" src='themes/images/terms.gif' onClick="placeAtCenterOfDiv(adv_filter_div,show_val2);showHideSelectDiv('show_val2');"/>
			<input type="image" align="absmiddle" style="cursor: pointer;" onclick="$('fval2').value='';return false;" language="javascript" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" src="themes/images/clear_field.gif"/>
			</td>
			<td class="dvtCellInfo"><?php echo $this->_tpl_vars['MOD']['LBL_AND']; ?>
</td>
			</tr>
			<tr>
			<td class="dvtCellLabel">
			...
			<?php echo $this->_tpl_vars['FOPTION3']; ?>

			</select>
			</td>
			<td class="dvtCellLabel"><input name="fval3" id="fval3" class="repBox" type="text" value="<?php echo $this->_tpl_vars['VALUE3']; ?>
">
			<img height=20 width=20 style="cursor: pointer;" title="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" src='themes/images/terms.gif' onClick="placeAtCenterOfDiv(adv_filter_div,show_val3);showHideSelectDiv('show_val3');"/>
			<input type="image" align="absmiddle" style="cursor: pointer;" onclick="$('fval3').value='';return false;" language="javascript" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" src="themes/images/clear_field.gif"/>
			</td>
			<td class="dvtCellLabel"><?php echo $this->_tpl_vars['MOD']['LBL_AND']; ?>
			...
			<?php echo $this->_tpl_vars['BLOCK4']; ?>
			...
			<?php echo $this->_tpl_vars['FOPTION4']; ?>

			</select>
			</td>
			<td class="dvtCellInfo"><input name="fval4" id="fval4" class="repBox" type="text" value="<?php echo $this->_tpl_vars['VALUE4']; ?>
">
			<img height=20 width=20 style="cursor: pointer;" title="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_FIELD_FOR_COMPARISION']; ?>
" src='themes/images/terms.gif' onClick="placeAtCenterOfDiv(adv_filter_div,show_val4);showHideSelectDiv('show_val4');"/>
			<input type="image" align="absmiddle" style="cursor: pointer;" onclick="$('fval4').value='';return false;" language="javascript" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" src="themes/images/clear_field.gif"/>
			</td>
			<td class="dvtCellInfo"><?php echo $this->_tpl_vars['MOD']['LBL_AND']; ?>
			...
			<?php echo $this->_tpl_vars['BLOCK5']; ?>
			...
			<?php echo $this->_tpl_vars['FOPTION5']; ?>

			</select>
			</td>
			<td class="dvtCellLabel"><input name="fval5" id="fval5" class="repBox" type="text" value="<?php echo $this->_tpl_vars['VALUE5']; ?>
">
				...
				<input type="image" align="absmiddle" style="cursor: pointer;" onclick="$('fval5').value='';return false;" language="javascript" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" src="themes/images/clear_field.gif"/</td>
			<td class="dvtCellLabel">&nbsp;</td>
			</tr>
		</tbody>
	</table>
					...
					<div class="layerPopup" id='show_val1'style="border:0; position: absolute; width:300px; z-index: 50; display: none;">
						...
						<td>
							...
							<tbody><tr background="themes/images/qcBg.gif" class="mailSubHeader">
								...
								<td align=right> <img border="0" align="absmiddle" src="themes/images/close.gif" style="cursor: pointer;" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" onclick="showHideSelectDiv('show_val1');"/></td
							</tbody></table>
							...
							<tbody><tr>
								...
								<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="white" class="small">
									...
									<td width="30%" align="left" class="cellText">
						        		...
						        		<?php echo $this->_tpl_vars['REL_FIELDS1']; ?>
...
" name="button" onclick="showHideSelectDiv('show_val1');" class="crmbutton small create" accesskey="X" title="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
"/>
									</td>
								</tr>
								</tbody></table>
					...
					<div class="layerPopup" id='show_val2'style="border:0; position: absolute; width:300px; z-index: 50; display: none;">
						...
						<td>
							...
							<tbody><tr background="themes/images/qcBg.gif" class="mailSubHeader">
								...
								<td align=right> <img border="0" align="absmiddle" src="themes/images/close.gif" style="cursor: pointer;" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" onclick="showHideSelectDiv('show_val2');"/></td
							</tbody></table>
							...
							<tbody><tr>
								...
								<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="white" class="small">
									...
									<td width="30%" align="left" class="cellText">
						        		...
						        		<?php echo $this->_tpl_vars['REL_FIELDS2']; ?>
								...
								<tbody><tr>
									<td width="50%" align="center">
										<input type="button" style="width: 70px;" value="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
" name="button" onclick="showHideSelectDiv('show_val2');" class="crmbutton small create" accesskey="X" title="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
"/>
									</td>
								</tr>
								</tbody></table>
					...
					<div class="layerPopup" id='show_val3'style="border:0; position: absolute; width:300px; z-index: 50; display: none;">
						...
						<td>
							...
							<tbody><tr background="themes/images/qcBg.gif" class="mailSubHeader">
								...
								<td align=right> <img border="0" align="absmiddle" src="themes/images/close.gif" style="cursor: pointer;" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" onclick="showHideSelectDiv('show_val3');"/></td
							</tbody></table>
							...
							<tbody><tr>
								...
								<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="white" class="small">
									...
									<td width="30%" align="left" class="cellText">
						        		...
						        		<?php echo $this->_tpl_vars['REL_FIELDS3']; ?>
								...
								<tbody><tr>
									<td width="50%" align="center">
										<input type="button" style="width: 70px;" value="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
" name="button" onclick="showHideSelectDiv('show_val3');" class="crmbutton small create" accesskey="X" title="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
"/>
									</td>
								</tr>
								</tbody></table>
					...
					<div class="layerPopup" id='show_val4'style="border:0; position: absolute; width:300px; z-index: 50; display: none;">
						...
						<td>
							...
							<tbody><tr background="themes/images/qcBg.gif" class="mailSubHeader">
								...
								<td align=right> <img border="0" align="absmiddle" src="themes/images/close.gif" style="cursor: pointer;" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" onclick="showHideSelectDiv('show_val4');"/></td
							</tbody></table>
							...
							<tbody><tr>
								...
								<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="white" class="small">
									...
									<td width="30%" align="left" class="cellText">
						        		...
						        		<?php echo $this->_tpl_vars['REL_FIELDS4']; ?>
								...
								<tbody><tr>
									<td width="50%" align="center">
										<input type="button" style="width: 70px;" value="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
" name="button" onclick="showHideSelectDiv('show_val4');" class="crmbutton small create" accesskey="X" title="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
"/>
									</td>
								</tr>
								</tbody></table>
					...
					<div class="layerPopup" id='show_val5'style="border:0; position: absolute; width:300px;z-index: 50; display: none;">
						...
						<td>
							...
							<tbody><tr background="themes/images/qcBg.gif" class="mailSubHeader">
								...
								<td align=right> <img border="0" align="absmiddle" src="themes/images/close.gif" style="cursor: pointer;" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLOSE']; ?>
" onclick="showHideSelectDiv('show_val5');"/></td
							</tbody></table>
							...
							<tbody><tr>
								...
								<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="white" class="small">
									...
									<td width="30%" align="left" class="cellText">
						        		...
						        		<?php echo $this->_tpl_vars['REL_FIELDS5']; ?>
								...
								<tbody><tr>
									<td width="50%" align="center">
										<input type="button" style="width: 70px;" value="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
" name="button" onclick="showHideSelectDiv('show_val5');" class="crmbutton small create" accesskey="X" title="<?php echo $this->_tpl_vars['APP']['LBL_DONE']; ?>
"/>
									</td>
								</tr>
								</tbody></table>
