<?php /* Smarty version 2.6.18, created on 2010-06-10 00:25:57
...
<div id="__listview__" <?php if ($this->_tpl_vars['_MODE'] == 'search'): ?>style='display:none;'<?php endif; ?>>
	...
	<tr class="toolbar">
		...
		<td width="100%">
			...
			<a class="link" href="?action=List&module=<?php echo $this->_tpl_vars['_MODULE']->name; ?>
&page=<?php echo $this->_tpl_vars['_PAGER']->previous(); ?>
&q=<?php echo $this->_tpl_vars['_SEARCH_Q']; ?>
"><img src="resources/images/iconza/yellow/left_arrow_24x24.png" border="0"></a>
			...
			<?php if ($this->_tpl_vars['_PAGER']->hasNext ( count ( $this->_tpl_vars['_RECORDS'] ) )): ?>
			<a class="link" href="?action=List&module=<?php echo $this->_tpl_vars['_MODULE']->name; ?>
...
?>
				<tr>
				<td width="100%">
					<a href="?action=Detail&id=<?php echo $this->_tpl_vars['_RECORD']->id; ?>
" target="_self"><?php echo $this->_tpl_vars['_RECORD']; ?>
</a>
				</td>
				<td>
					<a href="?action=Detail&id=<?php echo $this->_tpl_vars['_RECORD']->id; ?>
...
<div id="__searchbox__" <?php if ($this->_tpl_vars['_MODE'] != 'search'): ?>style='display:none;'<?php endif; ?>>
	<table width=100% cellpadding=0 cellspacing=0 border=0>
	<tr class="toolbar">
		<td><a class="link" href="?action=SearchConfig&module=<?php echo $this->_tpl_vars['_MODULE']->name; ?>
...
" />
				<input id='__searchbox__q_' type="text" name="q" class="searchbox" value="<?php echo $this->_tpl_vars['_SEARCH_Q']; ?>
"/>
			</form>
